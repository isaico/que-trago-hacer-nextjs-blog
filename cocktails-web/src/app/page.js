...
export default function Home() {
    return (
        <main className="text-gray-500">
            {/* hero section */}
            <section className="bg-center bg-no-repeat bg-[url('https://res.cloudinary.com/dzyllqqxi/image/upload/v1692819606/pexels-chris-f-1283219_z11q9e.jpg')] bg-cover bg-gray-700 bg-blend-multiply w-screen h-1/2">
                <div className=" text-center py-24 lg:py-56 grid justify-center ">
