const SocialIcons = ({ color = 'text-gray-700', size = 'w-6', inFooter }) => {
    return (
        <div className="flex mt-4 space-x-5 justify-center items-center sm:mt-0">
            <a
                href="https://instagram.com/isaico.dev?igshid=NGVhN2U2NjQ0Yg=="
            ...
            >
                <svg
                    ...
                    viewBox="0 0 448 512"
                    fill="currentColor"
                    className={`${color} ${size} hover:text-primary`}
                >
            ...
            <a
                href="https://www.linkedin.com/in/isaias-garcia-dev/"
                target="_blank"
                className="text-gray-500 hover:text-gray-900 dark:hover:text-white"
            >
                <svg
                ...
                <span className="sr-only">Linkedn</span>
            </a>
            {inFooter ? (
                <a
                    href="https://instagram.com/isaico.dev?igshid=NGVhN2U2NjQ0Yg=="
