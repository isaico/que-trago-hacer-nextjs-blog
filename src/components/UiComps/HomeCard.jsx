    ...
    return (
        <div className="bg-gray-50  border-2 border-primary  rounded-lg p-8 md:p-12 shadow-lg relative ">
            ...
            <p className="text-lg font-normal text-gray-500  mb-4">
                Los tragos tienen una larga historia que se remonta a la antigua
                Grecia y Roma. Descubre cómo evolucionaron los cócteles desde
                entonces.
            </p>
            <Link
                href="#"
                className="text-primary  hover:underline font-medium text-xl inline-flex items-center group "
            >
                Ver articulo
                <svg
